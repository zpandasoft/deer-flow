...
def get_context_analyzer_system_prompt() -> str:
    """
    获取上下文分析智能体的默认系统提示词。
...
def get_context_analysis_prompt(query: str, available_knowledge: str = "", locale: str = "zh-CN", current_time: str = None) -> str:
    """
    获取上下文分析提示词。
    
    Args:
        query: 用户查询
        available_knowledge: 可用知识内容
        locale: 语言设置
